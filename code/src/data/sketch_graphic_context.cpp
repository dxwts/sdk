...
, img_(0)
{
    ...
    screen_image_ = new QImage(direct_painter_->frameBuffer(), direct_painter_->screenWidth(), direct_painter_->screenHeight(), direct_painter_->linestep(), 4/*QScreen::instance()->pixelFormat()*/);
#endif
#endif
